...
const config = {
  ...
  copy: {
    patterns: [
      {
        from: 'src/pages/testCopy/',
        to: 'dist/weapp/pages/testCopy/'
      },
      // {
      //   from: 'src/pages/testCopy/index.js',
      //   to: 'dist/weapp/pages/testCopy/index.js'
      // },
      // {
      //   from: 'src/pages/testCopy/index.json',
      //   to: 'dist/weapp/pages/testCopy/index.json'
      // },
      // {
      //   from: 'src/pages/testCopy/index.wxml',
      //   to: 'dist/weapp/pages/testCopy/index.wxml'
      // },
    ]
  },
  ...
  h5: {
    ...
    webpackChain(chain) {
      chain.merge({
        ...
        output: {
          chunkLoadingGlobal: 'tripTaroH5Global' + parseInt(100 * Math.random(1))
        },
        optimization: {
          splitChunks: {
            cacheGroups: {
